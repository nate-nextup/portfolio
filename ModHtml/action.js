...
document.querySelector('#change-me-button').onclick = function() {
    document.querySelector('#change-me-title').innerHTML = 'Hello, my name is nate!'
  }
  ...
  */
  ...
  document.querySelector('#delete-me-button').onclick = function(){
    let original = document.querySelector('.delete-me-title');    original.parentNode.removeChild(original);  }
